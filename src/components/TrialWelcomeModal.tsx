        ...
        {!emailSubmitted ? (
          ...
          <>
            <div className="modal-header">
              ...
              <h2>Set Up Your API Key (2 Minutes)</h2>
              <button className="modal-close" onClick={onClose}>✕</button>
            </div>
            ...
            <div className="modal-body">
              <div className="api-guide">
                <div className="guide-section">
                  <h3>✨ Option A: Groq (100% Free, Private, Fast)</h3>
                  <ol>
                    <li>Visit <a href="https://console.groq.com" target="_blank" rel="noopener noreferrer">console.groq.com</a></li>
                    <li>Click "Sign Up" and create an account (takes 2 min)</li>
                    <li>Go to API Keys in the left sidebar</li>
                    <li>Click "Create API Key" and copy it</li>
                    <li>Paste it in Growth Hub Settings → API Config</li>
                  </ol>
                  <p className="guide-note">✅ Completely free, unlimited tokens, your conversations stay private. This is the best option for most people.</p>
                </div>

                <div className="guide-section">
                  <h3>🚀 Option B: OpenRouter (Also Free, More Model Options)</h3>
                  <ol>
                    ...
                    <li>Create a new API key and copy it</li>
                    <li>
                      Go to <a href="https://openrouter.ai/settings/privacy" target="_blank" rel="noopener noreferrer">Privacy Settings</a> 
                      and enable "Allow free model usage" (required)
                    </li>
                    <li>Paste your key in Growth Hub Settings → API Config</li>
                  </ol>
                  <p className="guide-note">
                    ✅ Also free and unlimited! More model options available. 
                    ⚠️ Free models may use conversations for training. If privacy matters, use Groq instead.
                  </p>
                </div>

                <div className="guide-section">
                  <h3>💎 Option C: OpenAI (Highest Quality, Paid)</h3>
                  <ol>
                    <li>Visit <a href="https://platform.openai.com/account/api-keys" target="_blank" rel="noopener noreferrer">platform.openai.com/api-keys</a></li>
                    <li>Sign in or create an account</li>
                    <li>Click "Create New Secret Key"</li>
                    <li>Copy and paste into Growth Hub Settings → API Config</li>
                    <li>Set up billing in your OpenAI account (you control costs)</li>
                  </ol>
                  <p className="guide-note">💰 Paid option (you pay to OpenAI). Highest quality models. Usually $1-5/month for typical use.</p>
                </div>

                <div className="guide-footer">
                  <p><strong>🏆 Best Options (Both Free & Unlimited):</strong></p>
                  <p>Groq (completely private) or OpenRouter (free but data used for training)</p>
                  <p>Go to Settings → API Config to add your key anytime.</p>
                </div>
              </div>
            </div>
